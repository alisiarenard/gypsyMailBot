...
const NO_ROUTES = `По указанному маршруту нет данных.\nТы можешь подписаться на маршрут и в течение следущих <b>14 дней</b> получать уведомления, если кто-то добавить информацию о нужном тебе маршруте`;
...
const SHARE_PHONE = 'Выбери способ для связи';
...
const DELETE_SUBSCRIPTION = 'Выбери маршрут для которого хотите удалить подписку:';
const NO_SUBSCRIPTIONS = 'Ты не подписан ни на один маршрут';
const EMPTY_ROUTES = 'Пока не добавлено ни одного маршрута';
const CHOICE_FROM_MENU = 'Выбери из предложенных вариантов в меню';
